...
dff = pd.read_excel('Desktop/dataScienceFiles/proteinDataSet.xlsx')                 # Reading our excel dataset
...
print(np.mean(decisionTreeWithoutFeatureSelection))
print(np.mean(knnWithoutFeatureSelection))
print(np.mean(gaussianWithoutFeatureSelection))
print(np.mean(dTWithFeatureSelection))
print(np.mean(knnWithFeatureSelection))
print(np.mean(gausWithFeatureSelection))
